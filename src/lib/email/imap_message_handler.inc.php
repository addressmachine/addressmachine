...
class imap_message_handler {
    ...
    public function get_subject() {
        return isset($this->_header->subject) ? $this->_header->subject : '';
    }
    ...
    public function get_to_address() {
        return $this->_header->to[0]->mailbox.'@'.$this->_header->to[0]->host;
        //return $this->_header->toaddress;
    }

    public function get_from_address() {
        return $this->_header->reply_to[0]->mailbox.'@'.$this->_header->reply_to[0]->host;
        //return $this->_header->from[0]->mailbox.'@'.$this->_header->from[0]->host;
